...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("think", "Enable thinking mode for Qwen3/reasoning models", "Configuration"),
    CommandDef("no_think", "Disable thinking mode for Qwen3/reasoning models", "Configuration",
               aliases=("no-think",)),
